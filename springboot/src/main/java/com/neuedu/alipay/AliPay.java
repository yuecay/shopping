 ...
 * @BelongsPackage: com.neuedu.alipay
 * @Author: 郝毓才
 * @CreateTime: 2019-10-27 14:56
 * @Description: 支付功能方法
 */
public class AliPay {
    ...
    public ServerResponse pay(Order order,List<OrderItem> orderItemList,String imageHost) {
       ...
       /* GoodsDetail goods1 = GoodsDetail.newInstance("goods_id001", "xxx小面包", 1000, 1);
        ...
        AlipayTradePrecreateRequestBuilder builder = new AlipayTradePrecreateRequestBuilder()
                ...
                .setNotifyUrl("http://y6ybpn.natappfree.cc/order/callback.do")//支付宝服务器主动通知商户服务器里指定的页面http路径,根据需要设置
